    ...
    public class DialogueManager
    {
        ...
        public void Update(GameTime gameTime)
        {
            if (_currentEntity != null)
            {
                ...
                if (keyState.IsKeyDown(Keys.Enter) && State.Instance.CurrentKey != State.Instance.PreviousKey)
                {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (_currentEntity != null)
            {
                ...
                spriteBatch.Draw(_dialogueBoxTexture, _dialogueBox, State.Instance.color == Color.White ? Color.Black : State.Instance.color);
