Shader "Custom/Shield"
{
    ...
    SubShader
    {
        ...
        // Capture the scene behind the shield so the surface can refract it.
        ...
        void vert(inout appdata_full v, out Input o)
        {
            ...
            // Push vertices along their normals when the impact ripple reaches them.
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            // Fresnel rim is strongest where the view direction grazes the surface.
            float rim = 1.0 - saturate(dot(normalize(IN.viewDir), o.Normal));
            float3 rimEmission = _RimColor.rgb * pow(rim, _RimPower);

            // Compare shield depth with scene depth to highlight contact edges.
