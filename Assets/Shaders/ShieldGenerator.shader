    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            d2f domain(h2d_main tessFactors, const OutputPatch<h2d, 3> patch, float3 barycentricCoords : SV_DomainLocation) {
                ...
                // Interpolate generated tessellation vertices from the original triangle control points.
                ...
                // tex2Dlod is required here because this stage runs before fragment derivatives exist.
