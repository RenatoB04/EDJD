...
public class TeamOutlineController : MonoBehaviour
{
    ...
    public Color teamBColor = new Color(1f, 0.5f, 0f); // laranja
    ...
    [Range(0f, 0.05f)] public float allyOutlineWidth  = 0.0f; // 0 = sem outline no aliado
    ...
    {
        int localTeam = GameInfo.MyChosenTeam; // tua escolha no lobby
